...
class _SuperAdminHomeState extends State<SuperAdminHome> {
  ...
  Widget _buildProfileActionButton({required IconData icon, required String label, required Color color, required VoidCallback onPressed,}) {
      ...
      children: [
        ...
        GridView.count(
          ...
          children: [
            ...
            _buildStatCard(
              title: 'In ProgressQueries',
              value: data?.inProgressQueries != null ? data!.inProgressQueries.toString() : '0',
              icon: Icons.autorenew,
              color: Color(0xFFEF4444),
              trend: 'All operational',
              onTap: ()=> Navigator.pushNamed(context, '/view-all-complaint-screen', arguments: 'In Progress'),
            ),
            _buildStatCard(
              ...
              color: Colors.red,
              trend: '+3 this month',
              onTap: ()=> Navigator.pushNamed(context, '/view-all-complaint-screen', arguments: 'Rejected'),
            ),
            _buildStatCard(
  ...
  Widget _buildStatCard({required String title, required String value, required IconData icon, required Color color, required String trend, VoidCallback? onTap,}) {
    return InkWell(
      onTap: onTap,
      child: Card(
        color: Colors.white,
      ...
      child: Column(
        ...
        children: [
          ...
          BuildActionButton(
            ...
            onTap: () => Navigator.pushNamed(context, '/view-all-complaint-screen'),
          ),
          ...
          BuildActionButton(
            title: 'Sector Admin Management',
            subtitle: 'Add and manage sector administrators',
